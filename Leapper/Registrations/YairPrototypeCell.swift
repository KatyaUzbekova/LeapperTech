//
//  YairPrototypeCell.swift
//  Leapper
//
//  Created by Екатерина Узбекова on 07.02.2021.
//  Copyright © 2021 Leapper Technologies. All rights reserved.
//

import UIKit

class YairPrototypeCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        imageAvatar.image = UIImage(named: "david_big.png")!
        imageAvatar.clipsToBounds = true
        
        messageLabel.text = NSLocalizedString("YairPrototypeCell.Label", comment: "Yair Prototype Cell")
