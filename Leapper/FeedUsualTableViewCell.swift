...
class FeedUsualTableViewCell: UITableViewCell {
    var isNewLabel = UILabel()
    
    var constraintSlider: NSLayoutConstraint!
    var constraintSlider2: NSLayoutConstraint!
    var constraintSlider3: NSLayoutConstraint!
    var constraintSlider4: NSLayoutConstraint!
    var constraintSlider5: NSLayoutConstraint!
    var heightConstraintSlider: NSLayoutConstraint!
        ...
        didSet {
            ...
            DispatchQueue.main.async {
                ...
                if self.chatMessage.isMeRecommended {
                    ...
                    self.constraintSlider3.isActive = false
                    self.constraintSlider.isActive = false
                    self.constraintSlider2.isActive = true
                    self.constraintSlider4.isActive = true
                    self.constraintSlider5.isActive = false
                }
                else {
                    self.bottomLabel.text =  NSLocalizedString("FeedUsualTableViewCell.Action.CheckServicesUsers", comment: "Click to see who used services")
                }
    ...
    func setRecommendedOnLabel(recomenndedOnJson: String?) {
        ...
        if let recommendedOn = recomenndedOnJson {
            ...
            if chatMessage.isMeRecommended {
                ...
                fullString = NSMutableAttributedString(string: finalString)
            }
            else {
    ...
    func setTextsFeatures() {
        ...
        profession.textColor = color1
        
        bottomLabel.textAlignment = .center
        bottomLabel.font = UIFont(name: "roboto", size: 13)
        bottomLabel.textColor = color1
    }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        constraintSlider = whomView.bottomAnchor.constraint(equalTo: slider.topAnchor, constant: -8)
        constraintSlider2 = whomView.bottomAnchor.constraint(equalTo: bottomLabel.topAnchor, constant: -8)
        constraintSlider3 = whoView.bottomAnchor.constraint(equalTo: bottomLabel.topAnchor, constant: -8)
        constraintSlider4 = whomView.topAnchor.constraint(equalTo: whoView.bottomAnchor, constant: 0)
        constraintSlider5 = slider.bottomAnchor.constraint(equalTo: bottomLabel.topAnchor, constant: -8)
        heightConstraintSlider =  slider.heightAnchor.constraint(equalToConstant: 300)
